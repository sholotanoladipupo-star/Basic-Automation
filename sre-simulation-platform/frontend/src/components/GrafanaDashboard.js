...
export default function GrafanaDashboard({ systemState }) {
    ...
    return (_jsxs("div", { className: "h-full bg-[#111217] font-mono text-xs text-[#9fa8be] overflow-y-auto", children: [_jsxs("div", { className: "flex items-center justify-between px-4 py-2 bg-[#161b22] border-b border-[#2c3235] flex-shrink-0", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "w-5 h-5 flex items-center justify-center", children: _jsxs("svg", { viewBox: "0 0 24 24", className: "w-4 h-4", fill: "#ff7c21", children: [_jsx("circle", { cx: "12", cy: "12", r: "10", fill: "none", stroke: "#ff7c21", strokeWidth: "2" }), _jsx("path", { d: "M12 6v6l4 2", stroke: "#ff7c21", strokeWidth: "2", strokeLinecap: "round" })] }) }), _jsx("span", { className: "text-[#e6edf3] font-medium text-[11px]", children: "Grafana" }), _jsx("span", { className: "text-[#484f58] text-[10px]", children: "/ moniepoint-prod / SRE Overview" })] }), _jsxs("div", { className: "flex items-center gap-3 text-[10px]", children: [_jsxs("span", { className: "text-[#ff7c21]", children: ["\u23F1 ", timeLabel] }), _jsx("span", { className: "text-[#3fb950]", children: "\u25CF Live" })] })] }), _jsxs("div", { className: "p-3 space-y-1", children: [_jsxs("div", { className: "grid grid-cols-4 gap-2 mb-3", children: [_jsx(StatCard, { label: "Services Total", value: String(services.length), color: "#e6edf3" }), _jsx(StatCard, { label: "Healthy", value: String(services.filter(s => s.status === 'healthy').length), color: "#3fb950" }), _jsx(StatCard, { label: "Degraded", value: String(services.filter(s => s.status === 'degraded').length), color: "#ff7c21" }), _jsx(StatCard, { label: "Down", value: String(services.filter(s => s.status === 'down').length), color: "#f85149" })] }), _jsx(CollapsibleRow, { title: "Kubernetes Pod Health", defaultOpen: true, children: _jsxs("div", { className: "p-3 space-y-2", children: [clusters.map(c => (_jsxs("div", { className: "flex items-center justify-between bg-[#1a1d2b] border border-[#2c3235] rounded px-3 py-1.5 text-[11px]", children: [_jsxs("span", { className: "text-[#8ab4f8]", children: ["\u2638 ", c.name] }), _jsxs("span", { className: `font-bold ${c.healthy_nodes === c.nodes ? 'text-[#3fb950]' : 'text-[#f85149]'}`, children: [c.healthy_nodes, "/", c.nodes, " nodes ready"] })] }, c.name))), _jsx("div", { className: "bg-[#1a1d2b] border border-[#2c3235] rounded overflow-hidden", children: _jsxs("table", { className: "w-full text-[11px]", children: [_jsx("thead", { className: "bg-[#111217] border-b border-[#2c3235]", children: _jsxs("tr", { children: [_jsx("th", { className: "text-left px-3 py-1.5 text-[#6b7280] font-normal", children: "Deployment" }), _jsx("th", { className: "text-left px-3 py-1.5 text-[#6b7280] font-normal", children: "Pods" }), _jsx("th", { className: "text-left px-3 py-1.5 text-[#6b7280] font-normal", children: "Status" }), _jsx("th", { className: "text-left px-3 py-1.5 text-[#6b7280] font-normal", children: "Restarts" }), _jsx("th", { className: "text-left px-3 py-1.5 text-[#6b7280] font-normal", children: "CPU" }), _jsx("th", { className: "text-left px-3 py-1.5 text-[#6b7280] font-normal", children: "Memory" })] }) }), _jsxs("tbody", { children: [services.map(svc => {
                                                    ...
                                                    })] })] }) })] }) }), _jsx(CollapsibleRow, { title: "System Resource Overview", defaultOpen: true, children: _jsxs("div", { className: "p-3 space-y-3", children: [_jsx("div", { className: "grid grid-cols-2 gap-3", children: services.map(svc => {
                                        const cpu = cpuPct(svc.status);
                                        const mem = memPct(svc.status);
                                        ...
                                        return (_jsxs("div", { className: "bg-[#1a1d2b] border border-[#2c3235] rounded p-3", children: [_jsxs("div", { className: "flex items-center justify-between mb-2", children: [_jsx("span", { className: "text-[#e6edf3] font-bold text-[11px]", children: svc.name }), _jsx("span", { className: `text-[10px] font-bold px-1.5 py-0.5 rounded ${svc.status === 'down' ? 'bg-[#2a0a0a] text-[#f85149]'
                                                                : svc.status === 'degraded' ? 'bg-[#2a1800] text-[#ff7c21]'
                                                                    : 'bg-[#0f2a1a] text-[#3fb950]'}`, children: svc.status.toUpperCase() })] }), _jsxs("div", { className: "grid grid-cols-2 gap-2", children: [_jsxs("div", { children: [_jsxs("div", { className: "flex items-center justify-between mb-1", children: [_jsx("span", { className: "text-[9px] text-[#6b7280]", children: "CPU" }), _jsxs("span", { className: "text-[10px] font-bold tabular-nums", style: { color: cpuColor }, children: [cpu, "%"] })] }), _jsx(Sparkline, { values: cpuHist, color: cpuColor })] }), _jsxs("div", { children: [_jsxs("div", { className: "flex items-center justify-between mb-1", children: [_jsx("span", { className: "text-[9px] text-[#6b7280]", children: "MEM" }), _jsxs("span", { className: "text-[10px] font-bold tabular-nums", style: { color: memColor }, children: [mem, "%"] })] }), _jsx(Sparkline, { values: memHist, color: memColor })] })] })] }, svc.name));
                                    }) }), databases.length > 0 && (_jsxs("div", { children: [_jsx("div", { className: "text-[9px] text-[#6b7280] uppercase tracking-widest mb-2", children: "Databases" }), _jsx("div", { className: "grid grid-cols-2 gap-2", children: databases.map(db => {
                                                ...
                                                return (_jsxs("div", { className: "bg-[#1a1d2b] border border-[#2c3235] rounded p-3", children: [_jsxs("div", { className: "flex items-center justify-between mb-2", children: [_jsx("span", { className: "text-[#e6edf3] font-bold text-[11px]", children: db.name }), _jsx("span", { className: `text-[10px] font-bold`, style: { color: db.status === 'healthy' ? '#3fb950' : db.status === 'degraded' ? '#ff7c21' : '#f85149' }, children: db.status.toUpperCase() })] }), _jsxs("div", { className: "space-y-1.5", children: [_jsxs("div", { children: [_jsxs("div", { className: "text-[9px] text-[#6b7280] mb-0.5", children: ["Connections (", db.connection_count, "/", db.max_connections, ")"] }), _jsx(Bar, { pct: connPct, warn: 70, crit: 90 })] }), _jsxs("div", { className: "flex items-center justify-between text-[10px]", children: [_jsx("span", { className: "text-[#6b7280]", children: "Query p99" }), _jsx("span", { className: "font-bold tabular-nums", style: { color: qColor }, children: db.query_latency_ms === 999999 ? '∞' : `${db.query_latency_ms}ms` })] })] })] }, db.name));
                                            }) })] })), caches.length > 0 && (_jsxs("div", { children: [_jsx("div", { className: "text-[9px] text-[#6b7280] uppercase tracking-widest mb-2", children: "Cache Layer" }), _jsx("div", { className: "grid grid-cols-2 gap-2", children: caches.map(cache => {
                                                ...
                                                return (_jsxs("div", { className: "bg-[#1a1d2b] border border-[#2c3235] rounded p-3", children: [_jsxs("div", { className: "flex items-center justify-between mb-2", children: [_jsx("span", { className: "text-[#e6edf3] font-bold text-[11px]", children: cache.name }), _jsx("span", { style: { color: cache.status === 'healthy' ? '#3fb950' : cache.status === 'degraded' ? '#ff7c21' : '#f85149' }, className: "text-[10px] font-bold", children: cache.status.toUpperCase() })] }), _jsxs("div", { className: "grid grid-cols-2 gap-2", children: [_jsxs("div", { children: [_jsxs("div", { className: "flex items-center justify-between mb-1", children: [_jsx("span", { className: "text-[9px] text-[#6b7280]", children: "Hit Rate" }), _jsxs("span", { className: "text-[10px] font-bold", style: { color: hitColor }, children: [Math.round(cache.hit_rate * 100), "%"] })] }), _jsx(Sparkline, { values: hitHist, color: hitColor })] }), _jsxs("div", { children: [_jsx("div", { className: "text-[9px] text-[#6b7280] mb-0.5", children: "Memory" }), _jsx(Bar, { pct: memPct2, warn: 75, crit: 90 }), _jsxs("div", { className: "text-[9px] text-[#6b7280] mt-0.5", children: [cache.memory_used_mb, "/", cache.memory_total_mb, " MB"] })] })] })] }, cache.name));
                            ...
                            })() }) }), _jsx(MySQLRow, { systemState: systemState })] })] }));
}

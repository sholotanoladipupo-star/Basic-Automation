...
function StatCard({ label, value, sub, color = '#e6edf3', bg }) {
    return (_jsxs("div", { className: "border rounded p-2.5 min-w-0", style: { background: bg ?? '#1a1d2b', borderColor: bg ? color + '40' : '#2c3235' }, children: [_jsx("div", { className: "text-[9px] uppercase tracking-widest mb-1", style: { color: bg ? color + 'aa' : '#6b7280' }, children: label }), _jsx("div", { className: "text-lg font-bold tabular-nums leading-none", style: { color }, children: value }), sub && _jsx("div", { className: "text-[10px] mt-0.5", style: { color: bg ? color + '88' : '#6b7280' }, children: sub })] }));
}
